...
con.connect(function(err){
    ...
    var salaryUpdate = ("UPDATE salary_grade SET salary = salary + 2000 WHERE employeeId = (SELECT s.employeeId FROM salary_grade s JOIN employees e ON s.employeeId = e.id WHERE e.yearsWithCompany > 3)");
